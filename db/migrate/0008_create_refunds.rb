class CreateRefunds < ActiveRecord::Migration[7.0]
  def change
    create_table :refunds do |t|
      ...
      t.integer :veichle_id, null: true # reference that don't need forengin key
      ...
      t.string :veichle_fr # it copy the linked fields in to a static field to preserve if veichle is deleted
